...
**최종 업데이트**: 2025-12-17 (Phase 15 완료)
...
### 🔴 긴급 - 보안 강화
- [x] ~~Rate Limiting 추가~~ ✅ Phase 15 완료
- [x] ~~XSS 방어 강화~~ ✅ Phase 15 완료
- [x] ~~WebSocket 이벤트 누락 수정~~ ✅ Phase 15 완료
- [x] ~~Electron 메모리 누수 수정~~ ✅ Phase 15 완료

### 🟠 중요 - 코드 품질 (2-3주)
- [ ] 중복 코드 제거 - Custom Hooks
  - App.jsx, AppRouter.jsx, ConsultationsPage.jsx 통합
  - 새 파일: `src/hooks/useConsultations.js`
  - 예상 효과: 1,310줄 → 400줄
- [ ] 백엔드 모듈화
  - server.js 1,602줄 분할
  - routes/, controllers/, middleware/ 구조 생성
- [ ] 검색 디바운싱
  - SearchBar.jsx에 useDebounce 훅 적용 (line 16)
  - 300ms 딜레이
- [ ] React.memo 최적화
  - ConsultationTable, Dashboard, SearchBar
